...
class FTTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        return a * res_deep + (1-a) * res_linear
...
# ==================== 可视化2：五个分量的攻角曲线图（各一个独立画布） ====================
# 提取测试集的原始攻角值（AA列，索引为2）
test_alpha = X_test[:, feature_columns.index('AA')]   # 或直接 X_test[:, 2]
